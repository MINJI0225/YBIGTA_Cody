...
# When importing from .registry, the followin objects are initialized
# and imported:
...
def _build_module(cfg, registry, default_args):
    ...
    - default_args: dict or None, default arguments to be used to initialize the module.

    """
    assert isinstance(cfg, dict) and 'type' in cfg
    assert isinstance(default_args, dict) or default_args is None
    args = cfg.copy()
    obj_type = args.pop('type') # RoIPredictor for model
